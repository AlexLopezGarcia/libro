...
public class LibroController {
    ...
    @Operation(summary = "Obtener información de un usuario", description = "Este endpoint retorna la información de un usuario por ID")
    @GetMapping("/usuario")
    public String obtenerUsuario(
            @Parameter(description = "ID del usuario") @RequestParam int id
        ) {
            return "Usuario: " + id;
        }
